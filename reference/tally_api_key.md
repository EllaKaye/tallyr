...
tallyr authenticates with a personal API key: create one at Tally
Settings \> API keys (<https://tally.so/settings/api-keys>) and store it
where tallyr can find it.
